...
public class MyNotifAdapter extends RecyclerView.Adapter<MyNotifAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!notification.isRead()) {
            // Tampilan untuk notifikasi belum dibaca
            ...
            // Tampilan untuk notifikasi sudah dibaca
        ...
        holder.itemView.setOnClickListener(v -> {
            if (!notification.isRead()) {
                ...
                // TODO: Update status baca pada sumber data (misalnya database)
            }
            // TODO: Handle klik notifikasi (misalnya membuka detail notifikasi)
        });
    }
